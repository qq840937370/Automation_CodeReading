...
{
    public partial class UI_MainForm_Scenario4 : Form
    {
        #region 全局变量
        ...
        public UI_MainForm_Scenario4(string uname)
        {
            InitializeComponent();
            rtaHalconWin = hWinctl_RTA.HalconWindow;
            icsHalconWin = hWinctl_ICS.HalconWindow;
        ...
        /// <param name="e"></param>
        private void UI_MainForm_Scenario4_Load(object sender, EventArgs e)
        {
            // 右下角时间显示
            timer_Now.Start();
